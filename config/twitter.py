...
entity_service = HTTPInferenceService(
    ...
    response_keys_to_columns=[
        ("entities00.type", AIDBListType()),
        ("entities00.entity", AIDBListType()),
        ("entities00.tweet_id", AIDBListType()),
        ("entities00.entity_id", AIDBListType()),
    ],
)
...
hate_service = HTTPInferenceService(
    ...
    columns_to_input_keys=["blobs00.tweet_id"],
    response_keys_to_columns=[
        ("hate01.tweet_id", AIDBListType()),
        ("hate01.ishate", AIDBListType()),
    ],
)
...
sentiment_service = HTTPInferenceService(
    ...
    columns_to_input_keys=["blobs00.tweet_id"],
    response_keys_to_columns=[
        ("sentiment02.tweet_id", AIDBListType()),
        ("sentiment02.sentiment", AIDBListType()),
    ],
)
...
topic_service = HTTPInferenceService(
    ...
    columns_to_input_keys=["blobs00.tweet_id"],
    response_keys_to_columns=[
        ("topic03.tweet_id", AIDBListType()),
        ("topic03.topic", AIDBListType()),
    ],
)
