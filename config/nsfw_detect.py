...
nsfw_detect_service = GoogleVisionAnnotate(
    ...
    columns_to_input_keys=[("requests", AIDBListType(), "image", "source", "imageUri")],
    ...
    default_args={
        ("requests", AIDBListType(), "features", "type"): "SAFE_SEARCH_DETECTION",
    ...
    "images": [
        {
            "name": "image_id",
            "is_primary_key": True,
            "refers_to": ("images_source", "image_id"),
            "dtype": int,
        },
