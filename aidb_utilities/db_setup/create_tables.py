    ...
    async with engine.begin() as conn:
        ...
        for table_name, columns in tables_info.items():
            ...
            for column in columns:
                ...
                columns_info.append(
                    sqlalchemy.Column(column["name"], dtype, primary_key=is_primary_key)
                )
                ...
                if "refers_to" in column:
                    ...
                    fk_constraints[fk_ref_table_name]["cols_refs"].append(
                        f"{column['refers_to'][0]}.{column['refers_to'][1]}"
                    )
            ...
            _ = sqlalchemy.Table(
                table_name, metadata, *columns_info, *multi_table_fk_constraints
            )
