...
class ChromaVectorDatabase(VectorDatabase):
    ...
    def create_index(
        self, index_name: str, similarity: str = "l2", recreate_index: bool = False
    ):
        """
    ...
    def query_by_embedding(
        ...
        """
        connected_index = self._connect_by_index(index_name)
        response = connected_index.query(
            query_embeddings=query_embeddings.tolist(), n_results=top_k, where=filters
        )
