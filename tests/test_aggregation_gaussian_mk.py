...
def generate_csv_file(mean, std_dev, num_samples):
    ...
    blobs_00 = pd.DataFrame(
        {
            "pk_blobs_00.id": list(range(num_samples)),
    ...
    gaussian00 = pd.DataFrame(
        {
            "pk_blobs_00.id": list(range(num_samples)),
            "pk_blobs_00.id2": list(range(100, 100 + num_samples)),
            "gaussian00.gaussian": samples,
        }
    )
    ...
    infer_gaussian00 = pd.DataFrame(
        {
            "in__blobs_00.id": list(range(num_samples)),
