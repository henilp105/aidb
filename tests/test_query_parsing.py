...
class UdfTestQuery:
    ...
    def _test_equality(self, config):
        ...
        assert all(
            any((e1 == UdfMapping(**e2)) for e2 in dataframe_sql["udf_mapping"])
            for e1 in self.dataframe_sql.udf_mapping
        )
        assert dataframe_sql["select_col"] == self.dataframe_sql.select_col
        filter_predicate = query.convert_and_connected_fp_to_exp(
    ...
    def _test_filtering_predicates(self, config):
        ...
        if parsed_fp != self.correct_fp:
            raise AssertionError(
                f"Failed to parse query: '{self.query_str}'. \n"
...
class QueryParsingTests(IsolatedAsyncioTestCase):
    ...
    async def test_nested_query(self):
        ...
        """,
                ...
                [["colors02.color = 'blue'"], ["objects00.x_min > 600"]],
                [{"colors02"}, {"objects00"}],
                [{"colors02"}, {"objects00"}],
                1,
            ),
    ...
    async def test_udf_query(self):
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(["col__0", "col__1"], "function1", ["function__0"]),
                        UdfMapping([], "function2", ["function__1"]),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(
                            ["col__1", "col__2", "col__3"], "function1", ["function__0"]
                        )
                    ],
                    ["col__0", "function__0"],
                    None,
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(["col__0", "col__4"], "is_equal", ["function__0"]),
                        UdfMapping(["col__5", "col__6"], "is_equal", ["function__1"]),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        ...
                        UdfMapping(["col__5", "col__6"], "is_equal", ["function__1"]),
                        UdfMapping(
                            ["col__7", "col__8"], "sum_function", ["function__2"]
                        ),
                    ],
                    ["col__0", "col__1", "col__2", "col__3"],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(
                            ["col__0", "col__1"], "multiply_function", ["function__0"]
                        ),
                        UdfMapping(["col__3", "col__4"], "is_equal", ["function__1"]),
                        UdfMapping(["col__5", "col__6"], "is_equal", ["function__2"]),
                        UdfMapping(
                            ["col__0", "col__7"], "sum_function", ["function__3"]
                        ),
                    ],
                    ["function__0", "col__2"],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(["col__3", "col__4"], "is_equal", ["function__0"]),
                        UdfMapping(["col__5", "col__6"], "is_equal", ["function__1"]),
                        UdfMapping(
                            ["col__0", "col__7"], "sum_function", ["function__2"]
                        ),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        ...
                        UdfMapping(
                            ["col__0", "col__7"], "multiply_function", ["function__3"]
                        ),
                    ],
                    ["col__0", "col__1", "col__2"],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(["col__0", "col__1"], "max_function", ["output1"]),
                        UdfMapping(["col__2", "col__3"], "power_function", ["output2"]),
                        UdfMapping(["col__5", "col__6"], "is_equal", ["function__2"]),
                        UdfMapping(["col__7", "col__8"], "is_equal", ["function__3"]),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(
                            ["col__1", "col__2"], "multiply_function", ["function__0"]
                        ),
                        UdfMapping(["col__4", "col__5"], "is_equal", ["function__1"]),
                        UdfMapping(["col__6", "col__7"], "is_equal", ["function__2"]),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(
                            ["col__2", "col__3"], "sum_function", ["function__0"]
                        ),
                        UdfMapping(
                            ["col__4", "col__5"], "multiply_function", ["function__1"]
                        ),
                    ],
        ...
        """,
                ...
                DataframeSql(
                    [
                        UdfMapping(["col__2", "col__3"], "sum_function", ["output1"]),
                        UdfMapping(
                            ["col__4", "col__5"], "multiply_function", ["function__1"]
                        ),
                    ],
